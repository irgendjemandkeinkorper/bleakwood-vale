...
export const ACT_CLOSES = {
  ...
  2:[
    ...
    {title:'The Ledger Opened', cond:'Whoever has traded an omen for a scene card this act begins this scene.',
     prompt:'Every debt in Bleakwood Vale comes due at once — money, favors, and the kind that can never be repaid in coin.',
  ...
  3:[
    {title:'The Reckoning', cond:'Whoever began the game’s very first scene begins its last.',
     ...
     elements:{Obsession:'Include the truth of the death, spoken plainly at last — whether or not anyone believes it.', Guilt:'Include a punishment that falls upon the wrong person, and is accepted willingly.', Dread:'Include what remains in Bleakwood Vale after this night — and who has seen it.'}},
    {title:'The Departure', cond:'Whoever holds the fewest cards begins this scene.',
     prompt:'Someone is leaving Bleakwood Vale forever — by train, by coach, or by hearse. The town assembles to see them off. Or to be certain they go.',
    ...
    {title:'The Last Confession', cond:'Whoever has revealed a Hidden Sin begins this scene — or, if none was revealed, whoever still holds one.',
     prompt:'One final unburdening, before the candles gutter out for good and Bleakwood Vale closes its account of this death.',
